...
public abstract class MengdeADTTest {
    ...
    protected MengdeADT<Integer> m;
    protected MengdeADT<Integer> a;
    protected MengdeADT<Integer> b;
    protected MengdeADT<Integer> c;

    protected abstract MengdeADT<Integer> nyMengde();
